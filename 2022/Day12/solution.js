...
const lines = fs.readFileSync("Day12/input.txt", { encoding: "utf-8" }) // read day??.txt content
...
const partOne = () => {
    ...
    console.log("PART ONE: The total syntax checking score is ", part1())
}

const partTwo = () => {

    console.log("PART TWO: The winning score is ", part2())
}
...
function part1() {
  ...
  return data.dist[pointToInt(input.end.x, input.end.y)];
}
...
function part2() {
  const input = getInput();
  return dijkstra2(input.map, input.end);
}
